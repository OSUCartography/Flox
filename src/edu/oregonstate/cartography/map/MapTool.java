 ...
 * interactivity based on pointer events.
 *
...
public abstract class MapTool {
     ...
     */
    protected AbstractSimpleFeatureMapComponent mapComponent;

    /**
     * Create a new instance.
     *
     * @param mapComponent The MapComponent for which this MapTool provides
     * services.
     */
    public MapTool(AbstractSimpleFeatureMapComponent mapComponent) {
        this.mapComponent = mapComponent;
    }

    /**
     * This method is called when the MapTool is activated, i.e. made the
     * current tool.
     */
    ...
    /**
     * This method is called when the MapTool is deactivated, i.e. it is no
     * longer the current tool.
     */
    ...
    public void endDrag(Point2D.Double point, MouseEvent evt) {
        /**
         * call mouseClicked. This makes sure a derived tool receives a
         * mouse-event if the mouse is clicked, dragged to another position and
         * released there. E.g. the ZoomOutTool does not overwrite startDrag,
         * updateDrag and endDrag and would therefore not receive an event if
         * the mouse is clicked, dragged and released.
         */
     ...
     * @return True while dragging, false otherwise.
     */
     ...
     *
     * @param g2d Graphics2D destination context to draw to.
     * @return True if the map has been completely drawn by this tool, false
     * otherwise.
     */
