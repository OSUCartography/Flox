...
/**
 * MapEventHandler - event listener for a map component. Receives key and mouse
 * events.
 *
...
public class MapEventHandler implements java.awt.event.MouseListener,
    ...
    private final ArrayList<MapToolMouseMotionListener> mouseMotionListeners = new ArrayList<>();
     ...
     * receives events.
     */
    public MapEventHandler(AbstractSimpleFeatureMapComponent mapComponent) {
     ...
     * receives key events before any other component can treat them. The event
