 ...
 * @version $Id: Bezier.java 717 2010-11-21 12:30:57Z rawcoder $
 */
public class Bezier {
    ...
    public static BezierPath fitBezierPath(java.util.List<Point2D.Double> digitizedPoints, double error) {
        ...
        // don't split at corners
        // segments = splitAtCorners(digitizedPoints, 77 / 180d * Math.PI, error * error);
        
        // only copy instead
        segments = new ArrayList<ArrayList<Point2D.Double>>(1);
     ...
     * fitCubicSegments(List<Point2D.Double>, double);
     *
     * @param digitizedPoints digited points.
     * @param error the maximal allowed error between the bezier path and the
     * digitized points.
     ...
     * digitized list into segments. Recommended value 44° = 44 * 180d /
     * Math.PI
