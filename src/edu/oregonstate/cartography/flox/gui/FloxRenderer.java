        ...
        for (Flow flow : flows) {
            ...
            if (flow instanceof CubicBezierFlow) {
                ...
                if (model.isDrawArrows()) {
                    ...
                    arrowPath.moveTo((arrow.baseInPx.x), (arrow.baseInPx.y));
                    arrowPath.lineTo(
                            (arrow.corner1.x), (arrow.corner1.y));
                    arrowPath.quadTo(
                            (arrow.corner1cPt.x), (arrow.corner1cPt.y),
                            (arrow.tip.x), (arrow.tip.y));
                    arrowPath.quadTo(
                            (arrow.corner2cPt.x), (arrow.corner2cPt.y),
                            (arrow.corner2.x), (arrow.corner2.y));
                    arrowPath.lineTo((arrow.baseInPx.x), (arrow.baseInPx.y));
